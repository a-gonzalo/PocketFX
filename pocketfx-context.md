...
3. **Inyección de Dependencias (CERO DOM Manual):** - **NUNCA** uses `document.getElementById` ni `querySelector` en los controladores. 
   ...
   - El framework sobrescribirá estas propiedades con los Nodos del DOM reales antes de llamar a `initialize()`.
